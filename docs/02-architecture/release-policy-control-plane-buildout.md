...
Step 12 is next. The goal is to build a policy test-pack format and runner so bundle activation can depend on executable policy checks, not only structural validity.
