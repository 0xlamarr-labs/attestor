...
Step 16 is complete. The next implementation step is Step 17: build the Envoy and Istio external-authz bridge so mesh and proxy deployments can pause, verify release authorization, and allow or deny consistently outside application code.
