...
| Release-layer buildout | Frozen implementation tracker in [docs/02-architecture/release-layer-buildout.md](docs/02-architecture/release-layer-buildout.md); Steps 01-03 complete in `src/release-kernel/types.ts`, `src/release-kernel/object-model.ts`, and `src/release-kernel/consequence-rollout.ts` |
