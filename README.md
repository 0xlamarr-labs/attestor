...
| Expanded verification surface | 1469 tests across 14 suites: 557 unit + 503 live API + 43 live PostgreSQL + 38 connector/filing + 98 healthcare E2E + 38 control-plane backup/restore + 46 control-plane backup/restore shared PG + 90 live shared control-plane PG + 15 live OTLP export + 12 live shared Redis rate-limit + 11 live async tenant execution Redis + 12 live multi-node HA proxy + 3 live Cypress connectivity + 3 live VSAC connectivity, plus env-gated live Snowflake and full ONC/VSAC credential runs |
